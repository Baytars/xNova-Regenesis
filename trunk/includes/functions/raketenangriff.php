...
function raketenangriff($defence_tech, $military_tech, $iraks, $def, $primaerziel = '0') {
   ...
   $hull[0] = 200 * (1 + $defence_tech / 10);
   $hull[1] = $hull[0];
   $hull[2] = 800 * (1 + ($defence_tech / 10));
   $hull[3] = 3500 * (1 + ($defence_tech / 10));
   $hull[4] = $hull[2];
   $hull[5] = 10000 * (1 + ($defence_tech / 10));
   $hull[6] = 2000 * (1 + ($defence_tech / 10));
   $hull[7] = $hull[5];
   $hull[8] = 1500 * (1 + ($defence_tech / 10));
   ...
   $schaden = floor(($def[10] - $def[9]) * (12000 * (1 + ($military_tech / 10))));
   if ($schaden < 0)
      $schaden = 0;
