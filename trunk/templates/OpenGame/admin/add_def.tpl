...
<tr>
	...
	<th>9</td>
	<th>Misil Intercepcion</td>
	<th><input name="interceptor_misil" type="text" value="0" /></th>
</tr><tr>
	<th>10</td>
	<th>Misile Interplan&eacute;tairo</td>
