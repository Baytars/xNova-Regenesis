...
while ($u = mysql_fetch_assoc($query)) {
	...
	if($u['activate_status']!=1){
	$bloc['adm_ul_data_detai'] = "<a href='http://".$_SERVER['HTTP_HOST']."/activate.php?hash=".base64_encode($u['username'])."&stamp=".base64_encode($u['id'])."&mode=options'>No</a>";
	}else{
	$bloc['adm_ul_data_detai'] = "Si";
	} // Lien vers une page de details genre Empire
