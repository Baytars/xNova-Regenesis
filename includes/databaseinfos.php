...
//
	...
	$QryTableBanned     .= "`who` varchar(25) character set utf8 NOT NULL default '', ";
	...
	$QryInsertConfig    .= "('mode_maintenance'		 , '0'),";
	$QryInsertConfig    .= "('attack_disabled'		 , '0'),";
	$QryInsertConfig    .= "('AtackBlocStart'		 , '0'),";
	$QryInsertConfig    .= "('AtackBlocEnd'			 , '0'),";
	$QryInsertConfig    .= "('OverviewClickBanner'	 , '')";
	$QryInsertConfig    .= ";";
	
	$QryTablediplo   .= "CREATE TABLE `{{table}}` (";
	$QryTablediplo   .= "`pact_owner` varchar(500) NOT NULL,";
	$QryTablediplo   .= "`pact_ally` varchar(500) NOT NULL,";
	$QryTablediplo   .= "`type` int(1) NOT NULL,";
	$QryTablediplo   .= "`accept` int(1) NOT NULL,";
	$QryTablediplo   .= "`pact_ally_id` int(5) NOT NULL";
	...
	$QryTableUsers      .= "`activate_status` tinyint(4) NOT NULL default '0', ";
	...
	$QryTableUsers      .= "`lang` varchar(8) character set utf8 NOT NULL default 'es', ";
	...
	$QryTableSupp       .= ") ENGINE = MYISAM CHARACTER SET utf8 COLLATE utf8_bin;";
