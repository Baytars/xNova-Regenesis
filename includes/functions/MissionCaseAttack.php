...
function MissionCaseAttack ( $FleetRow ) {
	...
	if ($FleetRow['fleet_start_time'] <= time()) {
		if ($FleetRow['fleet_mess'] == 0) {
			...
			$CurrentTechno=array();
			$CurrentTechno['military_tech']=$CurrentUser['military_tech'];
			$CurrentTechno['defence_tech']=$CurrentUser['defence_tech'];
			$CurrentTechno['shield_tech']=$CurrentUser['shield_tech'];
			...
			$TargetTechno=array();
			$TargetTechno['military_tech']=$TargetUser['military_tech'];
			$TargetTechno['defence_tech']=$TargetUser['defence_tech'];
			$TargetTechno['shield_tech']=$TargetUser['shield_tech'];
