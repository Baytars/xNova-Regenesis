...
"ALTER TABLE `{{prefix}}users` MODIFY `lang` varchar(8) character set utf8 NOT NULL default 'fr';",
...
`pact_ally_id` int(5) NOT NULL) ENGINE=MyISAM DEFAULT CHARSET=utf8;",
...
('urlaubs_modus_erz', '1'),
('forum_url', 'http://project.xnova.es'),
('OverviewNewsFrame', '1'),
('OverviewNewsText', 'Bienvenidos al Proyecto Xnova'),
