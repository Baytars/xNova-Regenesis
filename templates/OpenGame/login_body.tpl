...
<tr>
    <th width="126">
        <p><a href="forum/index.php" target="new">{log_forum}</a></p>
    </th>
    <th width="126">
        <p><a href="banned.php" target="new">{log_banned}</a></p>
    </th>
    <th width="122">
        <p><a href="contact.php" target="new">{log_contac}</a></p>
    </th>

    <th width="126">
        <div align="center">
            <a href="reg.php" ><font color="orange">{Register}</font></a>
        </div>
    </th>
</tr>
</table>
...
<tr>
    <td colspan="2" class="c">
        <span class="Stil1">{servername}</span>
    </td>
