...
<tr>
	...
	<td><div><a href="mats.php" accesskey="k" target="{mf}">{adm_addres}</a></div></td>
</tr><tr>
	<td ></td>
</tr><tr>
	...
	<td><div><a href="baneos.php" accesskey="k" target="{mf}">{adm_ban}</a></div></td>
</tr><tr>
	...
	<td><div><a href="Inactivos.php" accesskey="p" target="{mf}">{adm_list_inact}</a></div></td>
</tr><tr>
<td><div><a href="configstats.php" accesskey="p" target="{mf}">{adm_cfg_stat}</a></div></td>
</tr><tr>
